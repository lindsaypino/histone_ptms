function H3M_03_18_26(MS1_index,MS1_peaks,MS2_index,MS2_peaks,ptol,cur_outpath,special)
%%
...
load(out_file1);
His0.rt_ref(1,1) = repmat(auc(3,1),[1,1]);%K18me1
His0.rt_ref(2:3,1) = repmat(auc(4,1),[2,1]);%K18me1K23me1

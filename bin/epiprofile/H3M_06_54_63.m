function H3M_06_54_63(MS1_index,MS1_peaks,MS2_index,MS2_peaks,ptol,cur_outpath,special)
%%
...
His.mod_short = {'K56me11';
    'K56me21';
    'K56me22';
    'K56me31';
    'K56me32';
    'K56me33'};
His.mod_type = {'0,pr;3,me11;';
    '0,pr;3,me21;';
    '0,pr;3,me22;';
    '0,pr;3,me31;';
    '0,pr;3,me32;';
...
load(out_file1);
His0.rt_ref(1,1) = repmat(auc(2,1),[1,1]);%K56me1
His0.rt_ref(2:3,1) = repmat(auc(3,1),[2,1]);%K56me2
His0.rt_ref(4:6,1) = repmat(auc(4,1),[3,1]);%K56me3

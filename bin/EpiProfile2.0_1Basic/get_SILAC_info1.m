function get_SILAC_info1(MS1_index,MS1_peaks,MS2_index,MS2_peaks,special,ptol,cur_outpath,His0,main_ch_idx)
%%
...
hno = 1;
[cur_rts,cur_intens,cur_mono_isointens] = get_histone2(MS1_index,MS1_peaks,MS2_index,MS2_peaks,ptol,unitdiff,Mods,His0,hno,special);
if cur_rts(1,1)>0

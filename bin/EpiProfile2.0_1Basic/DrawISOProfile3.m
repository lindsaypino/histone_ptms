function DrawISOProfile3(raw_path,raw_names,ptol,special)
%%

if ptol==100
    ptol = 10;
end;
layout_path = fullfile(raw_path,'histone_layouts','C13');
...
for i=1:length(raw_names)
    ...
    if 1==special.nDAmode
        Extract_C13_1(MS1_index,MS1_peaks,MS2_index,MS2_peaks,special,ptol,cur_outpath);
    else
        Extract_C13_2(MS1_index,MS1_peaks,MS2_index,MS2_peaks,special,ptol,cur_outpath);
    end;
end;

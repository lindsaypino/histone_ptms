function H4M_02_20_23(MS1_index,MS1_peaks,MS2_index,MS2_peaks,ptol,cur_outpath,special)
%%
...
His.pep_seq = 'KVLR';
His.mod_short = {'K20me11';
    'K20me21';
    'K20me22';
    'K20me31';
    'K20me32';
    'K20me33'};
His.mod_type = {'0,pr;1,me11;';
    '0,pr;1,me21;';
    '0,pr;1,me22;';
    '0,pr;1,me31;';
    '0,pr;1,me32;';
...
load(out_file1);
His0.rt_ref(1,1) = repmat(auc(2,1),[1,1]);%K20me1
His0.rt_ref(2:3,1) = repmat(auc(3,1),[2,1]);%K20me2
His0.rt_ref(4:6,1) = repmat(auc(4,1),[3,1]);%K20me3

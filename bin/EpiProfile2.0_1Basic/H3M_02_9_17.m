function H3M_02_9_17(MS1_index,MS1_peaks,MS2_index,MS2_peaks,ptol,cur_outpath,special)
%%
...
load(out_file1);
His0.rt_ref(1,1) = repmat(auc(2,1),[1,1]);%K9me1
His0.rt_ref(2:3,1) = repmat(auc(3,1),[2,1]);%K9me2
His0.rt_ref(4:6,1) = repmat(auc(4,1),[3,1]);%K9me3
His0.rt_ref(7,1) = repmat(auc(7,1),[1,1]);%K9me1K14ac
His0.rt_ref(8:9,1) = repmat(auc(8,1),[2,1]);%K9me2K14ac
His0.rt_ref(10:12,1) = repmat(auc(9,1),[3,1]);%K9me3K14ac
